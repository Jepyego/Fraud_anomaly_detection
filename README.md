...
The dataset used in this project is the Credit Card Fraud Detection dataset from Kaggle, originally published by the Machine Learning Group - ULB.

The original dataset contains 284,807 transactions, including 492 fraudulent transactions.

Due to GitHub file-size limitations, the original `creditcard.csv` is not included in this repository.This project analyzes credit card transactions to identify fraudulent and unusual transaction patterns using machine learning and business intelligence tools.
...
![Legitimate vs Fraudulent Transactions](Images/fraud_distribution.png)

 Transaction Amount Analysis

![Transaction Amount Analysis](Images/transaction_amount_analysis.png)

 Fraudulent Transactions Over Time

![Fraudulent Transactions Over Time](Images/fraud_over_time.png)

 Model Comparison

![Fraud Detection Model Comparison](Images/model_comparison.png)
